            ...
            <div id="project-dashboard-main-content">
              ...
              <div id="dashboard-printable-area" style={{ padding: '20px 25px 25px 25px' }}>
                        ...
                        {dashboardData === null ? (
                          ...
                          <tr>
                            <td colSpan="5" style={{ padding: '20px', textAlign: 'center', color: '#64748b' }}>
                              No milestones found for this project. Upload a tracker Excel file to populate data.
                            </td>
                          </tr>
                        )}
                      </tbody>
                ...
                {visibleSections.criticalIssues && (
                  <div style={{ marginBottom: '28px' }} className="critical-issues-wrapper">
                    {(() => {
                      const dbProject = masterProjects.find(p => p.name === activeProject?.name);
                      const dbProjectId = dbProject?.id;
                      return dbProjectId ? (
                        <CriticalIssuesWidget projectId={dbProjectId} />
                      ) : (
                        <div style={{
                          padding: '30px', textAlign: 'center', color: '#6b7280',
                          backgroundColor: '#fff', border: '1px dashed #cbd5e1', borderRadius: '12px'
                        }}>
                          <strong>Project not in Database.</strong><br/>
                          Please save this project to the master database first to enable issue tracking.
                        </div>
                      );
                    })()}
                  </div>
