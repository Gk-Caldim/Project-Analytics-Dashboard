                              ...
                              <td style={{ padding: '12px 15px' }}>
                                <select
                                  ...
                                  style={{
                                    ...
                                    color: item.plan.implementation === 'On Track' ? '#059669' : item.plan.implementation === 'In Progress' ? '#1e293b' : '#dc2626',
                              ...
                              <td style={{ padding: '12px 15px' }}>
                                <select
                                  ...
                                  style={{
                                    ...
                                    color: item.actual.implementation === 'On Track' ? '#059669' : item.actual.implementation === 'In Progress' ? '#1e293b' : '#dc2626',
